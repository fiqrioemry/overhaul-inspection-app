...
const statusConfig: Record<string, { label: string; className: string }> = {
  ...
  REPAIRED: { label: "Repaired", className: "bg-teal-100 text-teal-700 dark:bg-teal-900/30 dark:text-teal-400" },
  VERIFIED: { label: "Verified", className: "bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400" },
