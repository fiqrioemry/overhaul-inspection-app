...
import { redirectToOAuth } from "@/features/auth/auth.api";
import type { OAuthProviderKey } from "@/constants/auth.constant";
...
export default function OAuthButton({ provider, label, icon, disabled }: OAuthButtonProps) {
