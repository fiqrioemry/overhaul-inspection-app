// src/features/inspection-requests/components/LegacyInspectionRequestPrintForm.tsx
// Original A4 portrait printable request form for PENETRANT_TEST / RADIOGRAPHY_TEST.
// Extracted verbatim from InspectionRequestPrintPage — do not redesign; the printed
// output must stay identical to the pre-extraction layout.
import { useNavigate } from "react-router-dom";
import { Printer, ArrowLeft } from "lucide-react";
import { Button } from "@/components/ui/button";
import { TEST_TYPE_LABELS, OBJECT_TYPE_LABELS } from "../inspection-request.constants";
import type { InspectionObjectType, InspectionRequestDetail } from "../inspection-requests.api";
...
export default function LegacyInspectionRequestPrintForm({ req }: Props) {
