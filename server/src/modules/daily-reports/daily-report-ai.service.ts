...
function buildSystemPrompt(
  ...
  const lines = [
    ...
    "2. Buat URAIAN KEGIATAN dalam bahasa Indonesia yang profesional dan teknis (maksimal 600 kata).",
    "   - Deskripsikan kondisi dan kegiatan yang terlihat di foto-foto",
    "   - Gunakan terminologi teknis inspeksi/overhaul tangki yang tepat",
    "   - Sertakan informasi seperti: area yang diinspeksi, kondisi fisik, temuan visual, metode kerja yang terlihat",
    "3. Buat CAPTION singkat untuk SETIAP foto (maksimal 80 kata, dalam bahasa Indonesia, teknis dan deskriptif).",
    ...
    '{',
    '  "description": "uraian kegiatan di sini",',
