  ...
  static async getInspectionRequestPrintData(c: Context) {
    ...
    const request = await pgsql.inspectionRequest.findFirst({
      ...
      include: {
        ...
        receivedByUser: { select: { id: true, name: true, position: true, company: { select: { id: true, name: true, type: true } } } },
        preparedByUser: { select: { id: true, name: true, position: true, company: { select: { id: true, name: true, type: true } } } },
        approvedByUser: { select: { id: true, name: true, position: true, company: { select: { id: true, name: true, type: true } } } },
