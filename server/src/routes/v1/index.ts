...
import tankProjects from "./tank-projects.route";
import tankProcesses from "./tank-processes.route";
import inspectionRequests from "./inspection-requests.route";
import inspectionFormTemplates from "./inspection-form-templates.route";
