...
user.get("/followers/:userId", protect, limitter(userLimit.GET_FOLLOWERS), ctrl.getFollowers);
user.get("/followings/:userId", protect, limitter(userLimit.GET_FOLLOWING), ctrl.getFollowing);
